...
ChatLogic::ChatLogic()
{
    ...
    //_chatBot = new ChatBot("/home/datta/Studies/udacity/cpp/CppND-Memory-Management-Chatbot/images/chatbot.png");
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        (_nodes.begin(), _nodes.end(), [&id](std::unique_ptr<GraphNode> &node){return node->GetID() == id; });
